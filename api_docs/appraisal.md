...
Поля аналогичны списку при создании. Дополнительные: ```id``` - идентификатор анкетирования, ```appraiseeId``` - внутренний идентификатор пользователя, по которому проводится анкетирование, ```initiatorId``` - внутрениий идентификатор пользователя-инициатора.
